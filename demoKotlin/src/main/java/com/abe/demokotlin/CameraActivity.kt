...
class CameraActivity : AppCompatActivity(), View.OnClickListener, OptionView.Callback {
    ...
    private val camera = findViewById<CameraView>(R.id.camera)

    //    private val ivPic: ImageView by lazy { findViewById(R.id.iv_pic) }
    private val ivPic = findViewById<ImageView>(R.id.iv_pic)

    //    private val controlPanel: ViewGroup by lazy { findViewById(R.id.controls) }
    private val controlPanel = findViewById<ViewGroup>(R.id.controls)
...
//                            frame.rotationToView
                            ...
                            bitmap.toString()
                            LOG.v("YourByteInfo: ", jpegByteArray)
                            ivPic.setImageBitmap(bitmap)
                        }
//                        else if(frame.format == ImageFormat.YUV_420_888) {
//                            val size = frame.size
//                            val outputFrame: com.google.android.gms.vision.Frame
//                            val data = frame.getData<Image>()
//                            outputFrame = com.google.android.gms.vision.Frame.Builder()
//                                    .setImageData(ByteBuffer.wrap(PictureRecorder.convertYUV420888ToNV21(data)),
//                                            size.getWidth(), size.getHeight(), ImageFormat.NV21)
//                                    .setId(mPendingFrameId)
//                                    .setTimestampMillis(mPendingTimeMillis)
//                                    .setRotation(getDetectorOrientation(frame.getRotationToUser()))
//                                    .build()
//                            data.close();
//                        }
                    }
    ...
    private fun getDetectorOrientation(sensorOrientation: Int): Int {
        when (sensorOrientation) {
            0, 360 -> return com.google.android.gms.vision.Frame.ROTATION_0
            90 -> return com.google.android.gms.vision.Frame.ROTATION_90
            180 -> return com.google.android.gms.vision.Frame.ROTATION_180
            270 -> return com.google.android.gms.vision.Frame.ROTATION_270
        }
        return com.google.android.gms.vision.Frame.ROTATION_90
    }
